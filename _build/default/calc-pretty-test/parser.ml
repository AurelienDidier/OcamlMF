...
module MenhirBasics = struct
  ...
  type token = 
    ...
    | LEQ
    | INT of (
# 5 "calc-pretty-test/parser.mly"
       (int)
# 23 "calc-pretty-test/parser.ml"
  )
    | IN
    | IF
    | ID of (
# 6 "calc-pretty-test/parser.mly"
       (string)
# 30 "calc-pretty-test/parser.ml"
  )
    | FALSE
    | EQUALS
    | EOL
...
# 1 "calc-pretty-test/parser.mly"
  
open Ast

# 47 "calc-pretty-test/parser.ml"
...
# 6 "calc-pretty-test/parser.mly"
       (string)
# 113 "calc-pretty-test/parser.ml"
)
...
let _menhir_action_01 =
  fun i ->
    (
# 39 "calc-pretty-test/parser.mly"
           ( Int i )
# 133 "calc-pretty-test/parser.ml"
     : (Ast.expr))

let _menhir_action_02 =
  fun x ->
    (
# 40 "calc-pretty-test/parser.mly"
          ( Var x )
# 141 "calc-pretty-test/parser.ml"
     : (Ast.expr))

let _menhir_action_03 =
  fun () ->
    (
# 41 "calc-pretty-test/parser.mly"
        ( Bool true )
# 149 "calc-pretty-test/parser.ml"
     : (Ast.expr))

let _menhir_action_04 =
  fun () ->
    (
# 42 "calc-pretty-test/parser.mly"
         ( Bool false )
# 157 "calc-pretty-test/parser.ml"
     : (Ast.expr))

let _menhir_action_05 =
  fun e1 e2 ->
    (
# 43 "calc-pretty-test/parser.mly"
                             ( Binop (Leq, e1, e2) )
# 165 "calc-pretty-test/parser.ml"
     : (Ast.expr))

let _menhir_action_06 =
  fun e1 e2 ->
    (
# 44 "calc-pretty-test/parser.mly"
                               ( Binop (Mult, e1, e2) )
# 173 "calc-pretty-test/parser.ml"
     : (Ast.expr))

let _menhir_action_07 =
  fun e1 e2 ->
    (
# 45 "calc-pretty-test/parser.mly"
                              ( Binop (Add, e1, e2) )
# 181 "calc-pretty-test/parser.ml"
     : (Ast.expr))

let _menhir_action_08 =
  fun e1 e2 x ->
    (
# 46 "calc-pretty-test/parser.mly"
                                                 ( Let (x, e1, e2) )
# 189 "calc-pretty-test/parser.ml"
     : (Ast.expr))

let _menhir_action_09 =
  fun e1 e2 e3 ->
    (
# 47 "calc-pretty-test/parser.mly"
                                                   ( If (e1, e2, e3) )
# 197 "calc-pretty-test/parser.ml"
     : (Ast.expr))

let _menhir_action_10 =
  fun e ->
    (
# 48 "calc-pretty-test/parser.mly"
                          (e)
# 205 "calc-pretty-test/parser.ml"
     : (Ast.expr))

let _menhir_action_11 =
  fun e1 e2 ->
    (
# 49 "calc-pretty-test/parser.mly"
                                           (Pair (e1,e2))
# 213 "calc-pretty-test/parser.ml"
     : (Ast.expr))

let _menhir_action_12 =
  fun e ->
    (
# 35 "calc-pretty-test/parser.mly"
                 ( e )
# 221 "calc-pretty-test/parser.ml"
     : (Ast.expr))
