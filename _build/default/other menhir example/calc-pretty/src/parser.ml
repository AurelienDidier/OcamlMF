...
module MenhirBasics = struct
  ...
  type token = 
    ...
    | LEQ
    | INT of (
# 5 "other menhir example/calc-pretty/src/parser.mly"
       (int)
# 23 "other menhir example/calc-pretty/src/parser.ml"
  )
    | IN
    | IF
    | ID of (
# 6 "other menhir example/calc-pretty/src/parser.mly"
       (string)
# 30 "other menhir example/calc-pretty/src/parser.ml"
  )
    | FALSE
    | EQUALS
    | EOF
...
# 1 "other menhir example/calc-pretty/src/parser.mly"
  
open Ast

# 46 "other menhir example/calc-pretty/src/parser.ml"
...
type ('s, 'r) _menhir_state = 
  ...
  | MenhirState26 : ((('s, _menhir_box_prog) _menhir_cell1_LPAREN, _menhir_box_prog) _menhir_cell1_expr, _menhir_box_prog) _menhir_state
    (** State 26.
...
# 6 "other menhir example/calc-pretty/src/parser.mly"
       (string)
# 112 "other menhir example/calc-pretty/src/parser.ml"
)
...
let _menhir_action_01 =
  fun i ->
    (
# 39 "other menhir example/calc-pretty/src/parser.mly"
           ( Int i )
# 132 "other menhir example/calc-pretty/src/parser.ml"
     : (Ast.expr))

let _menhir_action_02 =
  fun x ->
    (
# 40 "other menhir example/calc-pretty/src/parser.mly"
          ( Var x )
# 140 "other menhir example/calc-pretty/src/parser.ml"
     : (Ast.expr))

let _menhir_action_03 =
  fun () ->
    (
# 41 "other menhir example/calc-pretty/src/parser.mly"
        ( Bool true )
# 148 "other menhir example/calc-pretty/src/parser.ml"
     : (Ast.expr))

let _menhir_action_04 =
  fun () ->
    (
# 42 "other menhir example/calc-pretty/src/parser.mly"
         ( Bool false )
# 156 "other menhir example/calc-pretty/src/parser.ml"
     : (Ast.expr))

let _menhir_action_05 =
  fun e1 e2 ->
    (
# 43 "other menhir example/calc-pretty/src/parser.mly"
                             ( Binop (Leq, e1, e2) )
# 164 "other menhir example/calc-pretty/src/parser.ml"
     : (Ast.expr))

let _menhir_action_06 =
  fun e1 e2 ->
    (
# 44 "other menhir example/calc-pretty/src/parser.mly"
                               ( Binop (Mult, e1, e2) )
# 172 "other menhir example/calc-pretty/src/parser.ml"
     : (Ast.expr))

let _menhir_action_07 =
  fun e1 e2 ->
    (
# 45 "other menhir example/calc-pretty/src/parser.mly"
                              ( Binop (Add, e1, e2) )
# 180 "other menhir example/calc-pretty/src/parser.ml"
     : (Ast.expr))

let _menhir_action_08 =
  fun e1 e2 x ->
    (
# 46 "other menhir example/calc-pretty/src/parser.mly"
                                                 ( Let (x, e1, e2) )
# 188 "other menhir example/calc-pretty/src/parser.ml"
     : (Ast.expr))

let _menhir_action_09 =
  fun e1 e2 e3 ->
    (
# 47 "other menhir example/calc-pretty/src/parser.mly"
                                                   ( If (e1, e2, e3) )
# 196 "other menhir example/calc-pretty/src/parser.ml"
     : (Ast.expr))

let _menhir_action_10 =
  fun e1 e2 ->
    (
# 48 "other menhir example/calc-pretty/src/parser.mly"
                                           (Pair (e1,e2) )
# 204 "other menhir example/calc-pretty/src/parser.ml"
     : (Ast.expr))

let _menhir_action_11 =
  fun e ->
    (
# 49 "other menhir example/calc-pretty/src/parser.mly"
                          (e)
# 212 "other menhir example/calc-pretty/src/parser.ml"
     : (Ast.expr))

let _menhir_action_12 =
  fun e ->
    (
# 35 "other menhir example/calc-pretty/src/parser.mly"
                 ( e )
# 220 "other menhir example/calc-pretty/src/parser.ml"
     : (Ast.expr))
...
include struct
  ...
  and _menhir_run_27 : type  ttv_stack. (((ttv_stack, _menhir_box_prog) _menhir_cell1_LPAREN, _menhir_box_prog) _menhir_cell1_expr as 'stack) -> _ -> _ -> _ -> ('stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      match (_tok : MenhirBasics.token) with
      | TIMES ->
          let _menhir_stack = MenhirCell1_expr (_menhir_stack, _menhir_s, _v) in
