...
module MenhirBasics = struct
  ...
  type token = 
    ...
    | LEQ
    | INT of (
# 5 "calc-pretty/src/parser.mly"
       (int)
# 23 "calc-pretty/src/parser.ml"
  )
    | IN
    | IF
    | ID of (
# 6 "calc-pretty/src/parser.mly"
       (string)
# 30 "calc-pretty/src/parser.ml"
  )
    | FALSE
    | EQUALS
    | EOF
...
# 1 "calc-pretty/src/parser.mly"
  
open Ast

# 46 "calc-pretty/src/parser.ml"
...
let _menhir_action_01 =
  fun i ->
    (
# 39 "calc-pretty/src/parser.mly"
           ( Int i )
# 132 "calc-pretty/src/parser.ml"
     : (Ast.expr))

let _menhir_action_02 =
  fun x ->
    (
# 40 "calc-pretty/src/parser.mly"
          ( Var x )
# 140 "calc-pretty/src/parser.ml"
     : (Ast.expr))

let _menhir_action_03 =
  fun () ->
    (
# 41 "calc-pretty/src/parser.mly"
        ( Bool true )
# 148 "calc-pretty/src/parser.ml"
     : (Ast.expr))

let _menhir_action_04 =
  fun () ->
    (
# 42 "calc-pretty/src/parser.mly"
         ( Bool false )
# 156 "calc-pretty/src/parser.ml"
     : (Ast.expr))

let _menhir_action_05 =
  fun e1 e2 ->
    (
# 43 "calc-pretty/src/parser.mly"
                             ( Binop (Leq, e1, e2) )
# 164 "calc-pretty/src/parser.ml"
     : (Ast.expr))

let _menhir_action_06 =
  fun e1 e2 ->
    (
# 44 "calc-pretty/src/parser.mly"
                               ( Binop (Mult, e1, e2) )
# 172 "calc-pretty/src/parser.ml"
     : (Ast.expr))

let _menhir_action_07 =
  fun e1 e2 ->
    (
# 45 "calc-pretty/src/parser.mly"
                              ( Binop (Add, e1, e2) )
# 180 "calc-pretty/src/parser.ml"
     : (Ast.expr))

let _menhir_action_08 =
  fun e1 e2 x ->
    (
# 46 "calc-pretty/src/parser.mly"
                                                 ( Let (x, e1, e2) )
# 188 "calc-pretty/src/parser.ml"
     : (Ast.expr))

let _menhir_action_09 =
  fun e1 e2 e3 ->
    (
# 47 "calc-pretty/src/parser.mly"
                                                   ( If (e1, e2, e3) )
# 196 "calc-pretty/src/parser.ml"
     : (Ast.expr))

let _menhir_action_10 =
  fun e1 e2 ->
    (
# 48 "calc-pretty/src/parser.mly"
                                           (Pair (e1,e2) )
# 204 "calc-pretty/src/parser.ml"
     : (Ast.expr))

let _menhir_action_11 =
  fun e ->
    (
# 49 "calc-pretty/src/parser.mly"
                          (e)
# 212 "calc-pretty/src/parser.ml"
     : (Ast.expr))

let _menhir_action_12 =
  fun e ->
    (
# 35 "calc-pretty/src/parser.mly"
                 ( e )
# 220 "calc-pretty/src/parser.ml"
     : (Ast.expr))
